...
class RotateAgentMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        # Code to disable noti pop up of chrome browser
        profile = webdriver.FirefoxOptions()
        profile.set_preference("dom.webnotification.enabled", False)
        profile.set_preference("app.updated.enabled", False)
        # profile.update_preferences()

        driver = webdriver.Firefox(executable_path=GEKODRIVER,
...
class Tiki1DownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
